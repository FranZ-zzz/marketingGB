                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class = "form-group">
                                            ...
                                            <input type="number" class="form-control" value="{{$producto->stock_minimo}}" name="stock_minimo">
                                            @error('stock_minimo')
                                                <small style="color: red">{{$message}}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class = "form-group">
                                            ...
                                            <input type="number" class="form-control" value="{{$producto->stock_maximo}}" name="stock_maximo">
                                            @error('stock_maximo')
                                                <small style="color: red">{{$message}}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class = "form-group">
                                            ...
                                            <input type="number" class="form-control" value="{{$producto->precio_compra}}" name="precio_compra">
                                            @error('precio_compra')
                                                <small style="color: red">{{$message}}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class = "form-group">
                                            ...
                                            <input type="number" class="form-control" value="{{$producto->precio_venta}}" name="precio_venta">
                                            @error('precio_venta')
                                                <small style="color: red">{{$message}}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="from-group">
                                            ...
                                            <textarea class="form-control" name="descripcion" cols="30" rows="2">{{$producto->descripcion}}</textarea>
                                            @error('descripcion')
                                                <small style="color: red">{{$message}}</small>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="form group">
                                    ...
                                    <br>
                                    <center>
                                        <output id ="list"><img src="{{asset('storage/'.$producto->imagen)}}" width="300px" alt="imagen"></output>
                                    </center>
                                    <script>
